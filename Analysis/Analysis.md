...
\[Chart 3.2 - MACD and Signal Indicators](charts/Macd\_vs\_signal.png)
...
\[3.3 - WIG20 with transactions](charts/WIG20\_transactions.png)
...
\[4.1 - MACD and Signal indicators during days 200-300](charts/Partial\_MACD\_Signal\_1.png) | \[4.2 - WIG20 with transactions during days 200-300](charts/Partial\_WIG20\_1.png)

\*Chart 4.1 - MACD and Signal indicators during days 200-300\* | \*Chart 4.2 - WIG20 with transactions during days 200-300\*

\[4.3 - MACD and Signal indicators during days 600-675](charts/Partial\_MACD\_Signal\_2.png) | \[4.4 - WIG20 with transactions during days 600-675](charts/Partial\_WIG20\_2.png)
...
\[5.1 Daily valuation of the investment portfolio based on the WIG20 index price for that day](charts/Wallet\_history.png)
